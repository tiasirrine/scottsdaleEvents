...
class EventForm extends Component {
	constructor(props) {
		...
		this.state = {
			...
			operationsManager: this.eventProps
				? this.eventProps.operationsManager
				: '',
			...
			willCallCustomerName: this.eventProps
				...
				: '',
			willCallPickupDate: this.eventProps
				? this.eventProps.willCallPickupDate
				: '',
			willCallPickupTime: this.eventProps
				? this.eventProps.willCallPickupTime
				: '',
			willCallReturnDate: this.eventProps
				? this.eventProps.willCallReturnDate
				: '',
			willCallReturnTime: this.eventProps
				? this.eventProps.willCallReturnTime
				: '',
			collapse: false,
			errors: {}
		};
