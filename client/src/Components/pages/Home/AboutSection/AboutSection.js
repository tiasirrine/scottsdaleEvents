      ...
      <Container>
        <section className="my-5">
          ...
          <p className="lead grey-text w-responsive text-center mx-auto mb-5">
            Our collections have been handpicked and handcrafted with one specific
            goal in mind; to make your event look spectacular.
          </p>
          <Row>
            ...
            <Col md="4" className="md-0 mb-5">
              <h4 className="text-center font-weight-bold"> The Industry Choice</h4>
              <p className="grey-text text-justify">
