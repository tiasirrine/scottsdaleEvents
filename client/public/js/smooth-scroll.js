...
(function(root, factory) {
  ...
  function(root) {
    ...
    smoothScroll.animateScroll = function(anchor, toggle, options) {
      ...
      var endLocation = isNum
        ...
        : getEndLocation(
            anchorElem,
            headerHeight,
            parseInt(animateSettings.offset, 10)
      ...
      var loopAnimateScroll = function() {
        ...
        position =
          startLocation +
          distance * easingPattern(animateSettings.easing, percentage);
    ...
    var clickHandler = function(event) {
      ...
      if (
        toggle.hostname !== root.location.hostname ||
        toggle.pathname !== root.location.pathname ||
        !/#/.test(toggle.href)
      )
        return;
